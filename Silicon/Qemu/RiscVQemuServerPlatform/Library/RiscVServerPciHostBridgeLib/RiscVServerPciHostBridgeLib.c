  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, "GENERIC_ECAM_CONFIGURATION_BASE=0x%Lx, GENERIC_ECAM_CONFIGURATION_SIZE=0x%Lx\n",
   (UINT64)GENERIC_ECAM_CONFIGURATION_BASE, (UINT64)GENERIC_ECAM_CONFIGURATION_SIZE));// new added code
  ...
  //
  Status = MapGcdMmioSpace (0x30000000, 0x10000000);
